...
/* =========================================================
   CAT TM Worker V9 Exact-First Safe Rescue
   Arabic ↔ English
   أهداف التصميم:
   - exact / compact lookup أولاً بسرعة O(1)
   - fuzzy محدود ومرشحاته قليلة لتجنب البطء
   - حماية قوية من النتائج البعيدة
   - Needs Translation فقط إذا لا يوجد هدف آمن فوق minScore
========================================================= */
